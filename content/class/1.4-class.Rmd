...
Answers to last class’ [practice problems](/practice/1.3-practice) on simple comparative advantage are posted on that page. **More practice questions (and answers) have also been added there!** Today you will be working on [practice problems](/practice/1.4-practice) on the Ricardian one-factor model. Answers will be posted later.

# Assignments

None!

# Translating Between Textbook and Class
...
ggplot(data.frame(x=c(0,m/px)), aes(x=x))+
  ...
  annotate("text", x = (0.5*(m/px)+1.75), y = BC(0.5*(m/px)), label = expression(paste("slope =", - MPL[y]/MPL[x])), color="blue", size =7)+
