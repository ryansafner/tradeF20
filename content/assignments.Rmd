...
This semester, we will hold a tournament to determine "the most interesting economist in history." There will be a single-elimination NCAA-basketball-style tournament bracket, with each "region" being an era or theme in the history of economic thought. I will determine "seeds" and match-ups between two economists, and each of you will vote on which economist in each matchup is more "interesting." For each head-to-head vote, you must explain your vote in 2-3 sentences.

You can vote for whomever you want in each matchup, but your explanations should be derived from some combination of the key concepts the economist contributed, their influence on their contemporaries or modern economics, and anything else you find relevant.

We will only consider economists that we have discussed and read in this course. By necessity, we must leave out a lot of interesting, influential, and worthy economists from consideration.
