...
**With regard to Hecksher-Ohlin theory, it is not _absolute_ differences in land, labor, or capital (factor endowments) between nations, but _relative_ endowments. For example, a poor country may have less labor and less capital than a wealthy country, but it may have more labor \emph{relative} to capital than a wealthy nation, which may have more capital _relative_ to labor. This would make the poor country a labor “abundant” country and give it a comparative advantage in exporting labor intensive goods.**
