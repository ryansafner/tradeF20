---
title: "2.2 — Quotas, Subsidies, and NTBs"
...
- In general, we call these .hi-purple[non-tariff barriers] to trade (NTBs)
]
]
.pull-right[
.center[
...
- .hi[Import quota] places a quantitative limit on the number of imported units allowed
...
- .hi[Export subsidy] is a subsidy (payment to encourage production) of exported goods
...
g+
  geom_hline(yintercept = 4, size = 2, color = "orange")+
  geom_label(x = 10, y = 4, color = "orange", label = "World Supply")+
  geom_vline(xintercept=c(8,12), size = 2)+
  annotate("segment", x = 8, xend = 12, y = 18, yend = 18, color = "black", size=2, alpha=1, arrow=arrow(length=unit(0.5,"cm"), ends="both", type="closed"))+
  geom_label(x = 10, y = 18, label = "Quota \n 4 bn lbs")
```
]
...
- Quota will generate .hi-green[quota rents]: 4 bn lbs $\times$ 0.04/lb = $0.160 bn
...
imp+
  ...
  geom_label(x = 16, y = 4, color = "orange", label = "World Supply")+
  geom_vline(xintercept = 4, size = 2, color = "orange", alpha = 1)+
  geom_label(x = 4, y = 18, color = "orange", label = "World Supply (Quota)")+
  geom_segment(x = 12, y = 4, xend = 12, yend = 0, size = 1, linetype = "dotted")
```
]
...
.pull-left[
.smaller[
- Government gets tax revenues from tariffs, but who gets the .hi-green[quota rents]?
...
- Sounds like these firms just get the licenses for free?
  - No! .hi-purple[Rent-seeking]: firms compete to lobby the government to give the quota licenses to *their* firm and not other firms!
  - The privilege of having a scarce import license creates .hi[economic rents] above opportunity cost
...
.pull-left[
.quitesmall[
- .hi-purple[Volunetary Export Restraints (VERs)] Japan “agreed” to restrict its auto exports to U.S. (for fear of wider-ranging U.S. protectionism if this failed)
...
- .hi[Export subsidy]: government pays domestic firms for every unit they export
  - essentially, a *negative* tax on exports
]

.pull-right[
.center[
![](../images/windsubsidy.jpg)
]
]
...
.pull-right[
```{r}
e<-ggplot(data.frame(x=c(0,12)), aes(x=x))+
...
- .hi-blue[Domestic Demand] for wheat in U.S.
]
]
...
- .hi-red[Domestic Supply] of wheat in U.S.
...
- .hi-purple[World Demand] for U.S. wheat at $12/bushel
]
]
...
```{r}
e+
  geom_hline(yintercept = 12, size = 2, color = "purple")+
  geom_label(x = 18, y = 12, color = "purple", label = "World Demand")
```
]
...
.smaller[
- At $12/bushel:
  - .blue[U.S. consumers] want to consume 8 bn bushels
]
]
...
e+
  geom_hline(yintercept = 12, size = 2, color = "purple")+
  geom_label(x = 18, y = 12, color = "purple", label = "World Demand")+
  geom_segment(x = 8, y = 12, xend=8, yend=0, linetype="dotted", size=1)
```
]
...
- At $12/bushel:
  - .blue[U.S. consumers] want to consume 8 bn bushels
  - .red[U.S. producers] will produce 12 bn bushels
]
]
...
e+
  ...
  geom_label(x = 18, y = 12, color = "purple", label = "World Demand")+
  geom_segment(x = 8, y = 12, xend=8, yend=0, linetype="dotted", size=1)+
  geom_segment(x = 12, y = 12, xend=12, yend=0, linetype="dotted", size=1)
```
]
...
- At $12/bushel:
  - .blue[U.S. consumers] want to consume 8 bn bushels
  - .red[U.S. producers] will produce 12 bn bushels
  - U.S. will .purple[export] 4 bn bushels to the .purple[rest of the world]
]
]
...
e+
  ...
  geom_segment(x = 8, y = 12, xend=8, yend=0, linetype="dotted", size=1)+
  geom_segment(x = 12, y = 12, xend=12, yend=0, linetype="dotted", size=1)+
  annotate("segment", x = 8, xend = 12, y = 6, yend = 6, color = "purple", size=2, alpha=1, arrow=arrow(length=unit(0.5,"cm"), ends="both", type="closed"))+
  geom_label(x = 10, y = 6, color = "purple", label = "Exports")
```
]
...
e+
  geom_polygon(data = cs_e, aes(x = x, y = y), fill = "blue", alpha = 0.2)+
  geom_hline(yintercept = 12, size = 2, color = "purple")+
  geom_label(x = 18, y = 12, color = "purple", label = "World Demand")+
  geom_segment(x = 8, y = 12, xend=8, yend=0, linetype="dotted", size=1)+
  geom_segment(x = 12, y = 12, xend=12, yend=0, linetype="dotted", size=1)+
...
e+
  geom_polygon(data = cs_e, aes(x = x, y = y), fill = "blue", alpha = 0.2)+
  geom_polygon(data = ps_e, aes(x = x, y = y), fill = "red", alpha = 0.2)+
  geom_hline(yintercept = 12, size = 2, color = "purple")+
  geom_label(x = 18, y = 12, color = "purple", label = "World Demand")+
  geom_segment(x = 8, y = 12, xend=8, yend=0, linetype="dotted", size=1)+
  geom_segment(x = 12, y = 12, xend=12, yend=0, linetype="dotted", size=1)+
...
- Trade benefits .red[U.S. producers] at expense of .blue[U.S. consumers]
  - But gain is much bigger than loss!
]
]
.pull-right[
...
.pull-right[
```{r, fig.height=4}
exp_supply=function(x){10+0.5*x}

exp<-ggplot(data.frame(x=c(0,12)), aes(x=x))+
  stat_function(fun = "exp_supply", size = 2, color = "red")+
  geom_label(x = 16, y = exp_supply(16), color = "red", label = "U.S. Export Supply")+
  labs(x = "Quantity (Billions of bushels)",
       y = "Price",
       title = "Wheat Export Market")+
  scale_x_continuous(breaks=seq(0,20,2),
                     limits=c(0,22),
                     expand=c(0,0))+
  scale_y_continuous(breaks=seq(0,20,2),
...
exp+
  geom_hline(yintercept = 12, size = 2, color = "purple")+
  geom_label(x = 18, y = 12, color = "purple", label = "World Demand")+
  geom_segment(x = 4, y = 12, xend = 4, yend = 0, size = 1, linetype = "dotted")
```
...
.pull-left[
.smaller[
- Suppose the U.S. government pays a $4/bushel .hi-purple[subsidy] on wheat exports
]
]
.pull-right[
```{r}
e+
  geom_hline(yintercept = 12, size = 2, color = "purple", alpha = 0.5)+
  geom_label(x = 18, y = 12, color = "purple", label = "World Demand")+
  geom_hline(yintercept = 16, size = 2, color = "purple")+
  geom_label(x = 18, y = 16, color = "purple", label = "World Demand + s")+
  annotate("segment", x = 10, xend = 10, y = 12, yend = 16, color = "black", size=2, alpha=1, arrow=arrow(length=unit(0.5,"cm"), ends="both", type="closed"))+
  geom_label(x = 10, y = 14, label = "s=$4")
```
]
...
- At new domestic wheat price of $16/bushel
  - .blue[U.S. consumers] want to consume 4 bn lbs (less than before)
]
]
.pull-right[
```{r}
e+
  geom_hline(yintercept = 12, size = 2, color = "purple", alpha = 0.5)+
  geom_label(x = 18, y = 4, color = "purple", label = "World Demand")+
  geom_hline(yintercept = 16, size = 2, color = "purple")+
  geom_label(x = 18, y = 16, color = "purple", label = "World Demand + s")+
  geom_segment(x = 8, y = 12, xend = 8, yend = 0, linetype="dotted", size = 1)+
  geom_segment(x = 4, y = 16, xend=4, yend=0, linetype="dotted", size=1)+
  annotate("segment", x = 8, xend = 4, y = 10, yend = 10, color = "black", size=2, alpha=1, arrow=arrow(length=unit(0.5,"cm"), ends="last", type="closed"))
...
- At new domestic wheat price of $16/bushel
  - .blue[U.S. consumers] want to consume 4 bn lbs (less than before)
  - .red[U.S. producers] will produce 16 bn lbs (more than before)
]
]
.pull-right[
```{r}
e+
  ...
  geom_label(x = 18, y = 16, color = "purple", label = "World Demand + s")+
  geom_segment(x = 12, y = 12, xend = 12, yend = 0, linetype="dotted", size = 1)+
  geom_segment(x = 16, y = 16, xend=16, yend=0, linetype="dotted", size=1)+
  annotate("segment", x = 12, xend = 16, y = 10, yend = 10, color = "black", size=2, alpha=1, arrow=arrow(length=unit(0.5,"cm"), ends="last", type="closed"))
```
]
...
- At new domestic wheat price of $16/bushel
  - .blue[U.S. consumers] want to consume 4 bn lbs (less than before)
  - .red[U.S. producers] will produce 16 bn lbs (more than before)
  - U.S. will .purple[export] 12 bn lbs (more than before)
]
]
.pull-right[
```{r}
e+
  ...
  geom_segment(x = 4, y = 16, xend = 4, yend = 0, linetype="dotted", size = 1)+
  geom_segment(x = 16, y = 16, xend=16, yend=0, linetype="dotted", size=1)+
  annotate("segment", x = 4, xend = 16, y = 18, yend = 18, color = "purple", size=2, alpha=1, arrow=arrow(length=unit(0.5,"cm"), ends="both", type="closed"))+
  geom_label(x = 10, y = 18, color = "purple", label = "Exports")
```
]
...
- Subsidy is a government payment, so taxpayers must .purple[spend money]: $4/bushel $\times$ 12 bn bushels = \$48 bn
]
]
.pull-right[
```{r}
e+
  geom_rect(xmin = 4, xmax = 16, ymin = 12, ymax = 16, fill ="purple", alpha = 0.5)+
  geom_hline(yintercept = 12, size = 2, color = "purple", alpha = 0.5)+
  geom_label(x = 18, y = 12, color = "purple", label = "World Demand")+
  geom_hline(yintercept = 16, size = 2, color = "purple")+
  geom_label(x = 18, y = 16, color = "purple", label = "World Demand + s")+
...
e+
  geom_polygon(data = cs_sub, aes(x = x, y = y), fill = "blue", alpha = 0.2)+
  geom_rect(xmin = 4, xmax = 16, ymin = 12, ymax = 16, fill ="purple", alpha = 0.5)+
  geom_hline(yintercept = 12, size = 2, color = "purple", alpha = 0.5)+
  geom_label(x = 18, y = 12, color = "purple", label = "World Demand")+
  geom_hline(yintercept = 16, size = 2, color = "purple")+
...
e+
  geom_polygon(data = cs_sub, aes(x = x, y = y), fill = "blue", alpha = 0.2)+
  geom_polygon(data = ps_sub, aes(x = x, y = y), fill = "red", alpha = 0.2)+
  geom_rect(xmin = 4, xmax = 16, ymin = 12, ymax = 16, fill ="purple", alpha = 0.5)+
  geom_hline(yintercept = 12, size = 2, color = "purple", alpha = 0.5)+
  geom_label(x = 18, y = 12, color = "purple", label = "World Demand")+
  geom_hline(yintercept = 16, size = 2, color = "purple")+
...
- New source of market inefficiency created, .b[“deadweight loss (DWL)”]
  1. Overproduction at home
...
dwl2<-e+
  ...
  geom_polygon(data = ps_sub, aes(x = x, y = y), fill = "red", alpha = 0.2)+
  geom_rect(xmin = 4, xmax = 16, ymin = 12, ymax = 16, fill ="purple", alpha = 0.5)+
  geom_polygon(data = dwl_sl, aes(x = x, y = y), fill = "black", alpha = 0.4)+
  geom_hline(yintercept = 12, size = 2, color = "purple", alpha = 0.5)+
  geom_label(x = 18, y = 12, color = "purple", label = "World Demand")+
  geom_hline(yintercept = 16, size = 2, color = "purple")+
  geom_label(x = 18, y = 16, color = "purple", label = "World Demand + s")+
...
exp+
  geom_polygon(data = exp_dwl, aes(x = x, y = y), fill = "black", alpha = 0.4)+
  geom_hline(yintercept = 12, size = 2, color = "purple")+
  geom_label(x = 18, y = 12, color = "purple", label = "World Demand")+
  stat_function(fun = "exp_2", color = "darkred", size = 2)+
  geom_label(x = 16, y = exp_2(18), color = "darkred", label = "U.S. Export Supply + s")+
  geom_segment(x = 12, y = 16, xend = 12, yend = 0, size = 1, linetype = "dotted")+
  geom_segment(x = 4, y = 12, xend = 4, yend = 0, size = 1, linetype = "dotted")
```
...
1. .blue[Decrease in consumer surplus]:
  - $8 bn-$32 bn = .blue[-$24 bn]
  
2. .red[Increase in producer surplus]:
  - $128 bn-$72 bn = .red[$56 bn]

3. .green[Government spending expense]:
  - .purple[-$48 bn]
...
- A $56 bn gain to a small group of domestic sugar producers at a $24 expense to consumers, $48 bn expense to taxpayers
...
.pull-left[
- Some of the biggest effects of the .hi[European Union (EU)] have been on trade:
  
- Members of the EU & Schengen agreement have removed all tariffs between member countries
	
- The EU’s .hi-purple[Common Agricultural Policy (CAP)] is essentially one giant continental export subsidy of European agricultural products
  - protects inefficient agriculture in countries like France
...
.center[
![:scale 80%](../images/euexportsubsidies.png)
]
...
.center[
![:scale 80%](../images/EUexportsubsidies2.jpg)
]
...
.center[
![](../images/boeingexim.jpg)

Source: Mercatus Center 2014, [“Export-Import Bank is Still Boeing's Bank”](https://www.mercatus.org/publication/export-import-still-boeing-s-bank)]
...
.pull-left[
- Export subsidies are a form of .hi[“dumping”], where a country sells a good at a lower price in a foreign market than it charges at home
...
- Similar to .hi[predatory pricing] in industrial organization between firms in a market (price below cost to drive out competitors) 
