...
## [Political Economy in a Liberal Democracy](#3)

## [An Example: Sugar Tariffs](#13)

## [Rent-Seeking](#26)

## [Who Gets Protection](#45)
...
“What is distinctive in our approach is the role we ascribe to political contributions: .hi[we see the gifts made by interest groups not so much as investments in the outcomes of elections, but more as a means to influence government policy]. In our view, .hi[the manner of campaign and party finance in many democratic nations creates powerful incentives for politicians to peddle their policy influence.] Then .hi[the structure of trade protection is bound to reflect the outcome of a competition for political favors]; this is the central theme in our story,” (p.848)
