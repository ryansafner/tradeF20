...
ggplot(data=notigers, aes(x=ef,y=Total))+
  geom_point(aes(color=continent))+
  geom_smooth(data=freedom,method="lm")+
  geom_label(data=tigers, aes(ef, Total, label=ISO, color = continent))+
  xlab("Economic Freedom Score")+ylab("Political Freedom Score")+theme_slides+labs(caption="Economic Freedom Score (2016) from Frasier Institute [1], Political Freedom Score from FreedomHouse (2017) [2]")+theme(legend.position="bottom")
```
...
ggplot(data=notigers, aes(x=ef,y=gdp))+
  geom_point(aes(color=continent))+
  #geom_smooth(data=freedom,method="lm")+
  geom_label(data=tigers, aes(ef, gdp, label=ISO, color = continent))+
  scale_y_continuous(name="GDP per Capita ($)", labels=scales::dollar, breaks=seq(0,100000,20000))+
  xlab("Economic Freedom Score")+ylab("GDP per Capita")+theme_slides+theme(legend.position="bottom")+labs(caption="Economic Freedom Score (2016) from Frasier Institute [1], GDP per Capita from Gapminder (2018) [2]")
```
...
ggplot(data=notigers, aes(x=Total,y=gdp))+
  geom_point(aes(color=continent))+
  #geom_smooth(data=freedom,method="lm")+
  geom_label(data=tigers, aes(Total, gdp, label=ISO, color = continent))+
  scale_y_continuous(name="GDP per Capita ($)", labels=scales::dollar, breaks=seq(0,100000,20000))+
  xlab("Political Freedom Score")+ylab("GDP per Capita")+labs(caption="Political Freedom Score (2017) from FreedomHouse [1], GDP per Capita from Gapminder (2018) [2]")+theme_slides+theme(legend.position="bottom")
```
...
.source[Source: [WSJ](https://www.wsj.com/graphics/us-china-tariffs-industries/?mod=article_inline?mod=hp_lead_pos3)]
]
