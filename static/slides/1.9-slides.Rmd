...
| Exports timber, ag products | Exports services, sophisticated manuf. | Exports basic manuf. |
...
- .blue[Home]: $\uparrow$ wages, $\downarrow$ capital returns
- .red[Foreign]: $\downarrow$ wages, $\uparrow$ capital returns
]
...
$$p_c * MPK_c =r=p_s*MPK_s$$
  - $\uparrow MPK_c=\frac{w}{p_c}$ & $\uparrow MPK_s=\frac{w}{p_s}$
...
- Change in real income to capital:
$$p_c * MPK_c =r=p_s*MPK_s$$
  - $\downarrow MPK_c=\frac{w}{p_c}$ & $\downarrow MPK_s=\frac{w}{p_s}$
