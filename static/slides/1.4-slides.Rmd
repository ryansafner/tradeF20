...
<!--.footnote[<sup>.magenta[†]</sup> If you really want to know, or match what the textbook uses, I have defined the labor requirement as the inverse of labor's marginal product: `\\(l_x=\frac{1}{MPLx}\\)`, `\\(l_y=\frac{1}{MPLy}\\)`.]
-->
]
...
.content-box-green[
.hsmaller[
.i-green[Example]: Suppose the following facts to set up:
