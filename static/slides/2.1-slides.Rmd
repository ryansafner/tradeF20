...
l<-ggplot(data.frame(x=c(0,12)), aes(x=x))+
  stat_function(fun=Demand, geom="line", color="blue", size=2)+
  geom_label(x=8,y=Demand(8), color = "blue", label="Demand (U.S.)")+
  stat_function(fun=Supply, geom="line", color="red", size=2)+
  geom_label(x=12,y=Supply(12), color = "red", label="Supply (U.S.)")+
...
|---------|------:|------:|----:|--------:|---:|---:|---:|---:|
| Small (Belgium) | $0.04 | 16 bn | 4 bn | 12 bn | $1.280 bn | $0.080 bn | $0 | $0 |
| Large (U.S.) | $0.04 | 16 bn | 4 bn | 12 bn | $1.280 bn | $0.080 bn | $0 | $0 |
...
| Country | $p^*$ | $q^*$ | Domestic $q$ | .orange[Imports] | $\Delta$ .blue[CS] | $\Delta$ .red[PS] | .green[Tax Revenue] | .b[DWL] |
|---------|------:|------:|----:|--------:|---:|---:|---:|---:|
| Small (Belgium) | $0.08 | 12 bn | 8 bn | 4 bn | -$0.560 bn | $0.240 bn | $0.160 bn | -$0.160 bn |
| Large (U.S.) | $0.07 | 13 bn | 7 bn | 6 bn | -$0.435 bn | $0.035 bn | $0.240 bn | -$0.090 bn |
...
$$\$8,000-\color{green}{\$7,500}=\color{magenta}{\$500}$$
- Changes by:
